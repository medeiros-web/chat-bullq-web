  ...
  return (
    <div className="relative isolate flex h-svh w-full bg-white max-lg:flex-col lg:bg-zinc-100 dark:bg-zinc-900 dark:lg:bg-zinc-950">
      ...
      */}
      ...
      >
        {/* Mobile header — only shown when navbar has content */}
        {navbar && (
        ...
        <div className="flex flex-1 flex-col min-h-0 min-w-0 overflow-hidden pb-bottom-nav lg:pb-0 lg:bg-white lg:shadow-sm lg:ring-1 lg:ring-zinc-950/5 dark:lg:bg-zinc-900 dark:lg:ring-white/10">
          <SidebarCollapseContext.Provider value={{ collapsed, toggle: toggleCollapsed }}>
            {children}
          </SidebarCollapseContext.Provider>
        </div>
